# Rhoda Alewi – Portfolio Website

This is my personal portfolio built with **React** and **Chakra UI**.  
...
- Add more transition/animation using Framer Motion.
